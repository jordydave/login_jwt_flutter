...
import 'package:jwt/bloc/login/login_bloc.dart';
import 'package:jwt/model/login/login_body.dart';
import 'package:jwt/widget/widget_card_loading.dart';
...
class LoginScreen extends StatelessWidget {
  ...
  Widget _buildWidgetSizedBox(double height) => SizedBox(
        height: height,
      );
